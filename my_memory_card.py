...
def check_answer():
    if answers[0].isChecked():
        ...
        if (answers[1].isChecked() or answers[2].isChecked() or answers[3].isChecked()):
            show_correct(f'Неправильно\ Правильный ответ: {ult.text()}')
    if main_win.total != 0:
...
q1 = Question('Фигура с тремя углами', 'треугольник', 'параллелограмм', 'квадрат', 'прямая')
q2 = Question('Кто является президентом РФ?', 'В. В. Путин', 'И. В. Сталин', 'Н. С. Хрущёв', 'Л. И. Брежнев')
q3 = Question('Какая часть содержится в любом слове?', 'корень', 'суффикс', 'приставка', 'окончание')
q4 = Question('Что такое "грейпфрут"?', 'фрукт', 'овощ', 'человек', 'книга')
q5 = Question('В чью честь названа таблица химических элементов?', 'Д. И. Менделеев', 'А. С. Пушкин', 'Й. Гайдн', 'В. В. Путин')
q6 = Question('Какое было высшее сословие в 17 веке?', 'боярство', 'крестьянство', 'запредложение', 'оттекст')
q7 = Question('Каким знаком обозначается сложение?', '+', '-', '№', ':')
q8 = Question('Произведение плотности на объём - это...', 'масса', 'сила', 'молярная масса', 'время')
q9 = Question('Структурно-функциональная элементарная единица строения и жизнедеятельности всех организмов - это...', 'клетка', 'организм', 'кислота', 'ДНК')
q10 = Question('макромолекула, обеспечивающая хранение, передачу из поколения в поколение и реализацию генетической программы развития и функционирования организмов - это...','ДНК', 'РНК','белок','мозг')
...
q13 = Question('Первая печатная машинка была изобретена в....', '1868 г.', '1654 г.', '1908 г.', '203 г.')
q14 = Question('Компьютерный алгоритм, который имитирует поведение человеческого мозга при обработке данных - это...','нейросеть', 'операционная система', 'приложение', 'игра')
q15 = Question('Какая самая сильная кислота?', 'HSbF6', 'HCl', 'H2O', 'Cu(OH)2')
q16 = Question('Какого цвета осадок при реагировании HCl и AgNO3?', 'белый', 'голубой', 'красный', 'жёлтый')
q17 = Question('Как переводится apple?', 'яблоко', 'ягода', 'смартфон', 'машина')
q18 = Question('Как называются усы у животных?', 'вибриссы', 'эхолокаторы', 'уши', 'почки')
